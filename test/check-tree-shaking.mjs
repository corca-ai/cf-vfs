...
const M = {
  ...
  jq: "shell/commands/jq",
  jqCore: "core/jq",
  jsonValue: "core/json-value",
...
const PRESETS = [
  {
    ...
    include: [M.ls, M.applet, M.options, M.identity],
    exclude: [
      M.core,
      M.awk,
      M.fs,
  ...
  {
    name: "awk",
    config: "wrangler.awk-tree-shake.jsonc",
    describe: "the opt-in AWK applet and its bounded regex engine",
    include: [M.awk, M.applet, M.options, M.helpers, M.content, M.posixRegex],
    exclude: [
      M.core,
      M.fs,
      M.ls,
  ...
  },
  {
    ...
    exclude: [M.interactive, M.r2, M.curl, M.network, M.awk],
  },
  {
    name: "r2-opaque",
