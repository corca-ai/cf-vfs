...
const PRESETS = [
  ...
  },
  {
    ...
    exclude: [M.applet, M.helpers, M.core, M.fs, M.ls, M.text, M.linux, M.parser, M.shell, M.r2],
  },
  {
    name: "shell",
  ...
  },
  {
    ...
    exclude: [M.fs, M.ls, M.text, M.xargs, M.discovery, M.registry, M.linux, M.sql, M.r2],
  },
  {
    name: "default-registry",
    config: "wrangler.default-registry-tree-shake.jsonc",
    describe: "the convenience preset with every applet",
    include: [M.registry, M.core, M.fs, M.ls, M.text, M.xargs, M.discovery, M.shell, M.parser],
  ...
  },
  {
    ...
    include: [M.linux, M.registry, M.discovery, M.shell, M.parser, M.sql, M.doSql],
  ...
  },
  {
    ...
    exclude: [M.applet, M.core, M.fs, M.ls, M.text, M.linux, M.parser, M.shell, M.interactive],
  },
];
