...
const PRESETS = [
  ...
  },
  {
    ...
    exclude: [M.fs, M.ls, M.text, M.xargs, M.discovery, M.sh, M.registry, M.linux, M.sql, M.r2],
  },
  {
  ...
  },
  {
    ...
    include: [M.linux, M.registry, M.discovery, M.sh, M.shell, M.parser, M.sql, M.doSql],
